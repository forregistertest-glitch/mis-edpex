...
import { Save, Loader2, User, MapPin, Briefcase, Landmark, GraduationCap, Clock, Camera, Upload, Eye, EyeOff, Users, Award, TrendingUp, Plane } from "lucide-react";
...
export default function HRDataForm({
    initialData = {},
    onSubmit,
    onCancel,
    loading = false,
    ...
    const tabs = [
        ...
        { id: "family", label: "ข้อมูลครอบครัว", icon: <Users size={16} /> },
        { id: "honors", label: "เครื่องราชและรางวัล", icon: <Award size={16} /> },
        { id: "salary_history", label: "เลื่อนเงินเดือน", icon: <TrendingUp size={16} /> },
        { id: "leave_training", label: "ลาศึกษา/ฝึกอบรม", icon: <Plane size={16} /> },
    ...
    return (
        <div className="space-y-6">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-8">
                ...
                {/* Family Tab */}
                <div className={activeTab === "family" ? "block animate-in fade-in" : "hidden"}>
                    <div className="space-y-4 mb-8">
                        <h2 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-2">ข้อมูลครอบครัว (Family Information)</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 mb-1">สถานภาพสมรส</label>
                                <select className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none">
                                    <option>โสด</option>
                                    <option>สมรส</option>
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 mb-1">จำนวนบุตร</label>
                                <input type="number" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none" defaultValue="0" min="0" />
                            </div>
                            <div className="md:col-span-2">
                                <label className="block text-sm font-semibold text-slate-700 mb-1">ชื่อคู่สมรส <span className="text-[10px] bg-slate-100 border border-slate-200 px-1 rounded text-red-600 font-mono">MIS</span></label>
                                <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none privacy-mask" placeholder="ระบุชื่อ-นามสกุล" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 mb-1">อาชีพคู่สมรส</label>
                                <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none" placeholder="เช่น ข้าราชการ" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 mb-1">สถานที่ทำงานคู่สมรส</label>
                                <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none" placeholder="ระบุสถานที่" />
                            </div>
                        </div>
                    </div>

                    <div className="space-y-4 mb-8">
                        <h2 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-2">ข้อมูลบิดา-มารดา</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <h3 className="text-sm font-bold text-slate-600">บิดา</h3>
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1">ชื่อ-นามสกุล</label>
                                    <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none privacy-mask" placeholder="ชื่อบิดา" />
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1">อาชีพ</label>
                                    <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none" placeholder="อาชีพบิดา" />
                                </div>
                                <div>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-sm font-bold text-slate-600">มารดา</h3>
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1">ชื่อ-นามสกุล</label>
                                    <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none privacy-mask" placeholder="ชื่อมารดา" />
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1">อาชีพ</label>
                                    <input type="text" className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none" placeholder="อาชีพมารดา" />
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-slate-700 mb-1">สถานะ</label>
                                    <select className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 outline-none">
                ...
                {/* Honors & Awards Tab */}
                <div className={activeTab === "honors" ? "block animate-in fade-in" : "hidden"}>
                    <div className="space-y-4 mb-8">
                        <h2 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-2">เครื่องราชและรางวัล (Honors & Awards)</h2>
                        <div className="border border-slate-200 rounded-xl overflow-x-auto">
                            <table className="w-full text-left text-sm">
                                <thead className="bg-slate-50 border-b border-slate-200 text-slate-600">
                                    <tr>
                                        <th className="p-4 font-semibold">ปี พ.ศ.</th>
                                        <th className="p-4 font-semibold">ชื่อเครื่องราช/รางวัล</th>
                                        <th className="p-4 font-semibold">ประเภท</th>
                                        <th className="p-4 font-semibold">หน่วยงานที่มอบ</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 text-slate-700">
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td className="p-4">2565</td>
                                        <td className="p-4">เหรียญดีเด่นด้านการวิจัย</td>
                                        <td className="p-4">รางวัลวิชาการ</td>
                                        <td className="p-4">มหาวิทยาลัย</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td colSpan={4} className="text-center text-slate-400 p-8">ไม่มีข้อมูล (กรุณาเพิ่มข้อมูล)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <button type="button" className="px-4 py-2 bg-indigo-50 text-indigo-600 rounded-lg text-sm font-medium hover:bg-indigo-100 transition-colors">
                            + เพิ่มเครื่องราช/รางวัล
                        </button>
                    </div>
                </div>

                {/* Salary History Tab */}
                <div className={activeTab === "salary_history" ? "block animate-in fade-in" : "hidden"}>
                    <div className="space-y-4 mb-8">
                        <h2 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-2">ประวัติการเลื่อนเงินเดือน (Salary Increment History)</h2>
                        <div className="border border-slate-200 rounded-xl overflow-x-auto">
                            <table className="w-full text-left text-sm">
                                <thead className="bg-slate-50 border-b border-slate-200 text-slate-600">
                                    <tr>
                                        <th className="p-4 font-semibold">วันที่มีผล</th>
                                        <th className="p-4 font-semibold">เงินเดือนเดิม (บาท)</th>
                                        <th className="p-4 font-semibold">เงินเดือนใหม่ (บาท)</th>
                                        <th className="p-4 font-semibold">เพิ่มขึ้น (บาท)</th>
                                        <th className="p-4 font-semibold">ประเภทการเลื่อน</th>
                                        <th className="p-4 font-semibold">หมายเหตุ</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 text-slate-700">
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td className="p-4">01/10/2565</td>
                                        <td className="p-4 text-right">33,000</td>
                                        <td className="p-4 text-right font-bold text-emerald-600">35,000</td>
                                        <td className="p-4 text-right text-emerald-600">+2,000</td>
                                        <td className="p-4">เลื่อนตามผลงาน</td>
                                        <td className="p-4 text-slate-500">-</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td className="p-4">01/10/2564</td>
                                        <td className="p-4 text-right">31,500</td>
                                        <td className="p-4 text-right font-bold text-emerald-600">33,000</td>
                                        <td className="p-4 text-right text-emerald-600">+1,500</td>
                                        <td className="p-4">เลื่อนประจำปี</td>
                                        <td className="p-4 text-slate-500">-</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                {/* Leave for Study/Training Tab */}
                <div className={activeTab === "leave_training" ? "block animate-in fade-in" : "hidden"}>
                    <div className="space-y-4 mb-8">
                        <h2 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-2">ประวัติการลาศึกษาต่อและฝึกอบรม</h2>
                        
                        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mb-4">
                            <h4 className="text-blue-800 font-bold text-sm mb-1">การลาศึกษาต่อ (Study Leave)</h4>
                            <p className="text-blue-700 text-xs">บันทึกข้อมูลการลาเพื่อศึกษาต่อในระดับที่สูงขึ้น</p>
                        </div>
                            ...
                            <table className="w-full text-left text-sm">
                                <thead className="bg-slate-50 border-b border-slate-200 text-slate-600">
                                    <tr>
                                        <th className="p-4 font-semibold">ระดับการศึกษา</th>
                                        <th className="p-4 font-semibold">สาขาวิชา</th>
                                        <th className="p-4 font-semibold">สถาบัน</th>
                                        <th className="p-4 font-semibold">ประเทศ</th>
                                        <th className="p-4 font-semibold">ระยะเวลา</th>
                                        <th className="p-4 font-semibold">สถานะ</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 text-slate-700">
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td colSpan={6} className="text-center text-slate-400 p-8">ไม่มีประวัติการลาศึกษาต่อ</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg mb-4">
                            <h4 className="text-amber-800 font-bold text-sm mb-1">การลาฝึกอบรม/ดูงาน/วิจัย (Training/Study Visit/Research)</h4>
                            <p className="text-amber-700 text-xs">บันทึกข้อมูลการเข้าร่วมอบรม สัมมนา ดูงาน หรือทำวิจัยต่างประเทศ</p>
                        </div>
                            ...
                            <table className="w-full text-left text-sm">
                                <thead className="bg-slate-50 border-b border-slate-200 text-slate-600">
                                    <tr>
                                        <th className="p-4 font-semibold">ปี พ.ศ.</th>
                                        <th className="p-4 font-semibold">ประเภท</th>
                                        <th className="p-4 font-semibold">หัวข้อ/โครงการ</th>
                                        <th className="p-4 font-semibold">สถานที่</th>
                                        <th className="p-4 font-semibold">ประเทศ</th>
                                        <th className="p-4 font-semibold">ระยะเวลา (วัน)</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100 text-slate-700">
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td className="p-4">2565</td>
                                        <td className="p-4"><span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-bold">อบรม</span></td>
                                        <td className="p-4">Data Science Workshop</td>
                                        <td className="p-4">Singapore University</td>
                                        <td className="p-4">สิงคโปร์</td>
                                        <td className="p-4 text-center">5</td>
                                    </tr>
                                    <tr className="hover:bg-slate-50 transition-colors">
                                        <td colSpan={6} className="text-center text-slate-400 p-8">ไม่มีข้อมูลเพิ่มเติม</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <button type="button" className="px-4 py-2 bg-indigo-50 text-indigo-600 rounded-lg text-sm font-medium hover:bg-indigo-100 transition-colors">
                            + เพิ่มข้อมูลการอบรม/ดูงาน
                        </button>
                    </div>
                </div>
